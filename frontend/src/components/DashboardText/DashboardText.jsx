            ...
            <Grid container>
                <Grid item md={9}>
                    <Typography fontSize = 'large'>
                        <b>Transparency</b> is a decentralized supply chain management system that allows you to efficiently manage the product distribution chain efficiently yet easily. 
                        <br />
